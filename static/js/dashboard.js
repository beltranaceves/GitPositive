var loadingAnimation = `<svg class="spinner" width="65px" height="65px" viewBox="0 0 66 66" xmlns="http://www.w3.org/2000/svg">
                                       <circle class="path" fill="none" stroke-width="6" stroke-linecap="round" cx="33" cy="33" r="30"></circle>`

function setLoadingAnimation() {
  var button = document.getElementById("buttons01");
  button.innerHTML = loadingAnimation;
}
...
(function () {
  ...
  onvisible.add('.image.style1, p.style4', {
    style: 'zoom-in',
    speed: 1000,
    intensity: 5,
    delay: 0,
