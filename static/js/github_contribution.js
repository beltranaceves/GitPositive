...
(function ( $ ) {
        ...
        */
        ...
        var start = function(){
          ...
          for (  var i =0; i < month_position.length; i++){
            ...
            //loop_html += '<text x="'+ item.x +'" y="-5" class="style4" style="font-color: white">'+ month_name +'</text>';
          }
   ...
   /**       //Add Monday, Wenesday, Friday label
      ...
      **/    
          ...
          var wire_html = 
            '<svg width="822" height="125" viewBox="0 0 822 125"  class="js-calendar-graph-svg">'+
        ...
        var mouseEnter = function(evt){
          ...
          var count_text = ( count > 0 ) ? settings.texts[1]: settings.texts[0];
          if (count == 0) {
            count = "";
          }
          if (count == 1) {
          ...
          if (count == 2) {
            count = "Slightly negative";
          }
          if (count == 3) {
            count = "Neutral";
          }
          if (count == 4) {
            count = "Slightly positive";
          }
          if (count == 5) {
            count = "Very positive";
          }
          var text = `${count} ${count_text} on ${date}`;
